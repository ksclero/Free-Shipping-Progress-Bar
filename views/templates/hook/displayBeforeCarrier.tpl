...
<div class="free-shipping-progress-container" role="region" aria-label="Free shipping progress">
    <div class="free-shipping-progress-message{if $freeShippingData.is_free_shipping} free-shipping-progress-success{/if}"
        id="free-shipping-message-checkout"
        role="status"
        aria-live="polite"
    ...
    <div class="free-shipping-progress-bar-outer"
        ...
        aria-valuemin="0"
        aria-valuemax="100"
        aria-labelledby="free-shipping-message-checkout"
